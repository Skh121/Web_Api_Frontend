...
import LogNewTradeHeader from "../../components/admin/Log Management/LogNewTradeHeader";
...
const tradeValidationSchema = Yup.object({
  ...
  entryPrice: Yup.number().positive("Must be a positive number").required("Entry price is required"),
  positionSize: Yup.number().positive("Must be a positive number").required("Position size is required"),
...
const LogTrade = () => {
  ...
  const tradeSetupTags = [
    "Breakout", "Reversal", "Pullback", "News", "Earnings", "Technical", "Fundamental",
  ];
    ...
    <div className="bg-gray-900 text-gray-200 min-h-screen p-4 sm:p-6 md:p-8">
      <div className="mx-auto">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 sm:p-8 mt-6">
          ...
          {/* Use the formik.handleSubmit function */}
          <form onSubmit={formik.handleSubmit} className="mt-8 space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              ...
              <div>
                ...
                <TradeDirectionToggle
                  ...
                  setDirection={(dir) => formik.setFieldValue("tradeDirection", dir)}
                />
              </div>
              <DatePickerField
                label="Entry Date"
            ...
            <FileUpload
              ...
              error={formik.touched.chartScreenshot && formik.errors.chartScreenshot}
            />
